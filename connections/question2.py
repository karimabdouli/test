...
class PeerQ2(Peer):
    ...
    def send_data_to_backend(self):
        ...
        for key, value in self.peer_pool.items() :
...
class SimulationQ2(Simulation):
    ...
    def process_backend_data(self):
        ...
        for i in range(len(result[0])) :
            result[0][i] = result[0][i]/2 #this is to avoid counting a connection twice (between a peer "a" and a peer "b", which occurs in the conncection of "a" and "b")
